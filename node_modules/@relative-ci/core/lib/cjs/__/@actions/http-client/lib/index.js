...
var index$1 = require('../../../tunnel/index.js');
var index$2 = require('../../../undici/index.js');
...
function requireLib () {
	...
	var __awaiter = (index.__exports && index.__exports.__awaiter) || function (thisArg, _arguments, P, generator) {
	...
	index.__exports.HttpClient = index.__exports.HttpClientResponse = index.__exports.HttpClientError = index.__exports.MediaTypes = index.__exports.Headers = index.__exports.HttpCodes = void 0;
	index.__exports.getProxyUrl = getProxyUrl;
	index.__exports.isHttps = isHttps;
	const http = __importStar(require$$2__default.default);
	const https = __importStar(require$$3__default.default);
	const pm = __importStar(proxy.__require());
	const tunnel = __importStar(index$1.__require());
	const undici_1 = index$2.__require();
	var HttpCodes;
	(function (HttpCodes) {
	...
	})(HttpCodes || (index.__exports.HttpCodes = HttpCodes = {}));
	var Headers;
	(function (Headers) {
	    Headers["Accept"] = "accept";
	    Headers["ContentType"] = "content-type";
	})(Headers || (index.__exports.Headers = Headers = {}));
	var MediaTypes;
	(function (MediaTypes) {
	    MediaTypes["ApplicationJson"] = "application/json";
	})(MediaTypes || (index.__exports.MediaTypes = MediaTypes = {}));
	/**
	...
	index.__exports.HttpClientError = HttpClientError;
	...
	index.__exports.HttpClientResponse = HttpClientResponse;
	...
	index.__exports.HttpClient = HttpClient;
