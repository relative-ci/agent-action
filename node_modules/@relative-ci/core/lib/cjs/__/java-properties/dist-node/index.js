...
function requireDistNode () {
	if (hasRequiredDistNode) return index.__exports;
	hasRequiredDistNode = 1;

	Object.defineProperty(index.__exports, "__esModule", {
	  value: true
	});
	index.__exports.of = index.__exports.PropertiesFile = void 0;

	var _fs = _interopRequireDefault(require$$0__default.default);
	...
	index.__exports.PropertiesFile = PropertiesFile;
	...
	index.__exports.of = of;
	return index.__exports;
}

exports.__require = requireDistNode;
