...
function requireWebidl () {
	...
	const { types, inspect } = require$$6__default.default;
	const { markAsUncloneable } = require$$1__default.default;
	const { toUSVString } = util.__require();
...
exports.__require = requireWebidl;
