...
var symbols$1 = require('../fetch/symbols.js');
...
function requireCache () {
	...
	const { urlEquals, getFieldValues } = util.__require();
	const { kEnumerableProperty, isDisturbed } = util$1.__require();
	const { webidl: webidl$1 } = webidl.__require();
	const { Response, cloneResponse, fromInnerResponse } = response.__require();
	const { Request, fromInnerRequest } = request.__require();
	const { kState } = symbols$1.__require();
	...
	class Cache {
	  ...
	  async match (request, options = {}) {
	    ...
	    request = webidl$1.converters.RequestInfo(request, prefix, 'request');
	    options = webidl$1.converters.CacheQueryOptions(options, prefix, 'options');
	  ...
	  async matchAll (request = undefined, options = {}) {
	    ...
	    if (request !== undefined) request = webidl$1.converters.RequestInfo(request, prefix, 'request');
	    options = webidl$1.converters.CacheQueryOptions(options, prefix, 'options');
	  ...
	  async put (request, response) {
	    ...
	    request = webidl$1.converters.RequestInfo(request, prefix, 'request');
	    response = webidl$1.converters.Response(response, prefix, 'response');
