...
function requireAgent () {
	...
	const { kClients, kRunning, kClose, kDestroy, kDispatch, kInterceptors } = symbols.__require();
	...
	class Agent extends DispatcherBase {
	  constructor ({ factory = defaultFactory, maxRedirections = 0, connect, ...options } = {}) {
	    ...
	    this[kOptions] = { ...util$1.deepClone(options), connect };
...
exports.__require = requireAgent;
