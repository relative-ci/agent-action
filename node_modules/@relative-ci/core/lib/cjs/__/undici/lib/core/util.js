...
function requireUtil () {
	...
	const { kDestroyed, kBodyUsed, kListeners, kBody } = symbols.__require();
	...
	const nodeUtil = require$$6__default.default;
	const { stringify } = require$$7__default.default;
	const { EventEmitter: EE } = require$$4__default.default;
	const { InvalidArgumentError } = errors.__require();
	const { headerNameLowerCasedRecord } = constants.__require();
	const { tree: tree$1 } = tree.__require();
	...
	function headerNameToString (value) {
	  return typeof value === 'string'
	    ...
	    : tree$1.lookup(value) ?? value.toString('latin1').toLowerCase()
	}
