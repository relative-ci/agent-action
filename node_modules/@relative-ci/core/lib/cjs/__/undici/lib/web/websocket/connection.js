...
var util$1 = require('../fetch/util.js');
...
function requireConnection () {
	...
	const { uid, states, sentCloseFrameState, emptyBuffer, opcodes } = constants.__require();
	const {
	  kReadyState,
	  kSentClose,
	  kByteParser,
	...
	const { fireEvent, failWebsocketConnection, isClosing, isClosed, isEstablished, parseExtensions } = util.__require();
	...
	const { Headers, getHeadersList } = headers.__require();
	const { getDecodeSplit } = util$1.__require();
