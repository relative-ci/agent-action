...
var clientH1 = require('./client-h1.js');
var clientH2 = require('./client-h2.js');
var redirectInterceptor = require('../interceptor/redirect-interceptor.js');
...
function requireClient () {
	...
	const connectH1 = clientH1.__require();
	const connectH2 = clientH2.__require();
	  ...
	  async [kDestroy] (err) {
	    return new Promise((resolve) => {
	      ...
	      for (let i = 0; i < requests.length; i++) {
	        ...
	        util$1.errorRequest(this, request, err);
	      }
	...
	async function connect$1 (client) {
	  ...
	  try {
	    ...
	    if (client.destroyed) {
	      util$1.destroy(socket.on('error', noop), new ClientDestroyedError());
	      return
	    }
