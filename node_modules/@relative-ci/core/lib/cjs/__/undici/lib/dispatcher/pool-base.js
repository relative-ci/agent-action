...
var fixedQueue = require('./fixed-queue.js');
var symbols = require('../core/symbols.js');
var poolStats = require('./pool-stats.js');
...
function requirePoolBase () {
	...
	const { kConnected, kSize, kRunning, kPending, kQueued, kBusy, kFree, kUrl, kClose, kDestroy, kDispatch } = symbols.__require();
	const PoolStats = poolStats.__require();
...
exports.__require = requirePoolBase;
