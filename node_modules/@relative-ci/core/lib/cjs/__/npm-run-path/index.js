...
const npmRunPath = ({
	...
	const cwdString = cwd instanceof URL ? require$$1.fileURLToPath(cwd) : cwd;
...
const applyExecPath = (result, execPath, cwdPath) => {
	const execPathString = execPath instanceof URL ? require$$1.fileURLToPath(execPath) : execPath;
