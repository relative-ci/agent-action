...
export async function getWebpackStatsFromFile(basedir, filepath) {
...
export async function getWebpackStatsFromArtifact(token, inputArtifactName, inputArtifactWebpackStatsFile) {
